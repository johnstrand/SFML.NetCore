...
public class Font : ObjectBase
{
    ...
    {
        _myTextures[characterSize] = new Texture(sfFont_getTexture(CPointer, characterSize));
        return _myTextures[characterSize];
    }
    ...
    protected override void Destroy(bool disposing)
    {
        ...
        if (disposing)
        {
            foreach (var texture in _myTextures.Values)
            {
                texture.Dispose();
            }
    ...
    private readonly Dictionary<uint, Texture> _myTextures = new();
