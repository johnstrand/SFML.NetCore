...
public class Shader : ObjectBase
{
    ...
    public static Shader FromString(string vertexShader, string geometryShader, string fragmentShader)
    {
        ...
        return ptr == IntPtr.Zero ? throw new LoadingFailedException("shader") : new Shader(ptr);
    }
    ...
    ////////////////////////////////////////////////////////////
    /// <summary>
    /// <para>Change a float parameter of the shader</para>
    /// <para>
    ...
    ////////////////////////////////////////////////////////////
    /// <summary>
    /// <para>Change a 2-components vector parameter of the shader</para>
    /// <para>
    /// "name" is the name of the variable to change in the shader.
    ...
    ////////////////////////////////////////////////////////////
    /// <summary>
    /// <para>Change a 3-components vector parameter of the shader</para>
    /// <para>
    /// "name" is the name of the variable to change in the shader.
    ...
    ////////////////////////////////////////////////////////////
    /// <summary>
    /// <para>Change a 4-components vector parameter of the shader</para>
    /// <para>
    /// "name" is the name of the variable to change in the shader.
    ...
    ////////////////////////////////////////////////////////////
    /// <summary>
    /// <para>Change a color parameter of the shader</para>
    /// <para>
    /// "name" is the name of the variable to change in the shader.
    /// The corresponding parameter in the shader must be a 4x1 vector
    /// (vec4 GLSL type).
    ...
    ////////////////////////////////////////////////////////////
    /// <summary>
    /// <para>Change a matrix parameter of the shader</para>
    /// <para>
    /// "name" is the name of the variable to change in the shader.
    ...
    ////////////////////////////////////////////////////////////
    /// <summary>
    /// <para>Change a texture parameter of the shader</para>
    /// <para>
    /// "name" is the name of the variable to change in the shader.
    /// The corresponding parameter in the shader must be a 2D texture
    /// (sampler2D GLSL type).
    ...
    private readonly Dictionary<string, Texture> _myTextures = new();
    ...
    [DllImport(CSFML.graphics, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode), SuppressUnmanagedCodeSecurity, Obsolete]
