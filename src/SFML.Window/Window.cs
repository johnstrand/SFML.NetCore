...
public class Window : ObjectBase
{
    ...
    ////////////////////////////////////////////////////////////
    protected Window(IntPtr cPointer, int dummy) : base(cPointer)
    {
...
#pragma warning restore CS0618
    ...
    #region Imports
    [DllImport(CSFML.window, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode), SuppressUnmanagedCodeSecurity]
