...
public struct ContextSettings
{
    ...
    {
        return $"[ContextSettings] DepthBits({DepthBits}) StencilBits({StencilBits}) AntialiasingLevel({AntialiasingLevel}) MajorVersion({MajorVersion}) MinorVersion({MinorVersion}) AttributeFlags({AttributeFlags}) SRgbCapable({SRgbCapable})";
    }
